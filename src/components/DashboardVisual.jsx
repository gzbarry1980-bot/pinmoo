export function DashboardVisual() {
  return (
    <div className="dashboard-visual" aria-label="电商数据看板示意图">
      ...
      <div className="metric-card metric-roi"><span>付费 ROI</span><strong>3.42</strong><em>计划级拆解</em></div>
      <div className="metric-card metric-donut"><span>流量结构</span><div className="donut" /></div>
      <div className="metric-card metric-rate"><span>退款治理</span><strong>4.21%</strong><div className="bars"><i/><i/><i/><i/><i/></div></div>
    </div>
  );
}
