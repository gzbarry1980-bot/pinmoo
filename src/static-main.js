...
function Home() {
  ...
  const heroProof = isEn() ? '<span>Evidence-led content</span><span>Entity and fact consistency</span><span>No guaranteed recommendation</span>' : '<span>无需整理复杂资料</span><span>发送品牌名称与官网</span><span>工作日 24 小时内回复</span>';
...
function ContactForm() {
  ...
  return '<section class="contact-direct-panel" aria-labelledby="wechatConsultTitle"><div class="form-heading">' + icon('MessageCircle', 26) + '<h2 id="wechatConsultTitle">扫码添加微信，免费领取品牌 GEO 报告</h2></div><div class="direct-qr-block"><div class="wechat-qr-crop direct-qr"><img src="/assets/wechat-qr-mufeng.jpg" alt="添加品沐咨询微信，免费获取品牌 GEO 基础报告" loading="lazy"></div><div><strong>微信 / 手机同号：' + SITE.phoneDisplay + '</strong><p>备注“品牌GEO报告”，发送品牌名称、官网或店铺链接、主要平台和目标市场，可先免费获取一份基于公开信息的品牌 GEO 基础报告。</p><div class="direct-intents">' + intents + '</div><a class="direct-phone-link" href="tel:' + SITE.phone + '">' + icon('Phone', 18) + '拨打电话</a></div></div><div class="direct-service-box"><h3>品牌 GEO 报告会先看什么</h3><ul>' + servicesList + '</ul></div><details class="inquiry-template-box"><summary><span><strong>不知道怎么开口？</strong><small>展开并复制常用咨询话术</small></span>' + icon('ChevronDown', 20) + '</summary><div>' + templates + '</div></details><p class="direct-note">建议添加微信后，至少发送：品牌名称、官网或店铺链接、主要平台、目标市场，并备注“品牌GEO报告”。</p></section>';
}
