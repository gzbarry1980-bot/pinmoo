...
function InsightsPage() {
  const cards = insights.map(InsightCard).join('');
  return PageHero('经营洞察', '用真实经营问题组织内容：先解释数据口径，再给出判断方法和可执行清单。') +
